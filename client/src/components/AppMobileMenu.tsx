        ...
        <>
          ...
          >
            ...
            <div className="flex-1 overflow-y-auto py-2">
              <div className="space-y-1 p-2">
                {mainNavItems.map((item) => (
                  <button
                    key={item.label}
                    className={`w-full flex items-center px-3 py-2.5 rounded-md transition-colors duration-200 ${
                      location === item.href 
            ...
            <div className="p-4 border-t border-slate-800">
              <button
                className="w-full flex items-center px-3 py-2 text-slate-300 hover:bg-slate-800 hover:text-white rounded-md transition-colors duration-200"
