...
const menuItems: ReportingMenuItem[] = [
  { label: "Dashboards", href: "/reporting/dashboards", gradient: "from-blue-500 to-blue-600" },
  { label: "Reports", href: "/reporting/reports", gradient: "from-green-500 to-green-600" },
  { label: "Marketing Analytics", href: "/reporting/marketing-analytics", gradient: "from-purple-500 to-purple-600" },
  { label: "Sales Analytics", href: "/reporting/sales-analytics", gradient: "from-pink-500 to-pink-600" },
  { label: "Service Analytics", href: "/reporting/service-analytics", gradient: "from-amber-500 to-amber-600" },
  { label: "Forecast", href: "/reporting/forecast", gradient: "from-red-500 to-red-600" },
  { label: "Goals", href: "/reporting/goals", gradient: "from-cyan-500 to-cyan-600" },
];
