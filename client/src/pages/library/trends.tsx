  ...
  return (
    <div className="flex">
      ...
      <div className="flex-grow space-y-8 pl-6">
        <div>
          <h1 className="text-3xl font-bold tracking-tight">Google Trends Explorer</h1>
          <p className="text-muted-foreground">Analyze search trends and discover insights</p>
        </div>
